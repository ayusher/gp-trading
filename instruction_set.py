...
def genetic_algorithm():
    ...
    while True:
        ...
        for genome in population:
            ...
            li.append(GeneticStrategy(["AAPL"], "1d", genome).trade)
        ...
        temp.sort(reverse = True, key=lambda x: x[0][0] - x[0][1]/500 - ((x[0][0]/x[1]-1)/10 if x[1]!=0 else 0))
        print("best sharpe ratio", temp[0][0])
        #print()
